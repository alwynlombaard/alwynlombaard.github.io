...
(function(global) {
	...
	global.playListController = function ($scope, audio){
		...
		$scope.tracks = [
					...
					{'track':8,'name':'Opus 60 no 3 - Carcassi','length':'01:49','file':'Carcassi_Etude3_20141026_180555.mp3'},
					...
					{'track':15,'name':'Brouwer Study No 2','length':'01:10','file':'Brouwer_Study_No_2_20151004_140303.mp3'},
